...
export const reducer = createReducer(
  ...
  on(
    ...
    (state, { waterRatio, useBlendRatio, blendRatio, brew, unit }) => {
      return update(state, {
...
export const getTotalBrewDisplay = createSelector(getTotalBrew, (brew) =>
  Utils.roundDecimal(brew),
);
...
export const getGroundsInOunces = createSelector(getGrounds, (grounds) =>
  Utils.roundDecimal(grounds / 10.25),
);

export const getGroundsInML = createSelector(getGroundsInOunces, (grounds) =>
  Utils.roundDecimal(grounds * 29.574),
);

export const getGroundsInCups = createSelector(getGroundsInOunces, (grounds) =>
  Utils.roundDecimal(grounds / 8),
);
